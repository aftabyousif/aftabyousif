...
<script type="text/javascript">
	...
	function EditBlock (VENUE_ID,BLOCK_NO,BLOCK_NAME,BLOCK_LOCATION,BLOCK_REMARKS,SESSION_ID,SEATING_CAPACITY,RESERVED_FOR,BLOCK_ID){
		// alert("working");
