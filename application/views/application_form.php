...
$pdf->Image('assets/img/University_of_Sindh_logo.png',10,4,26,26);
...
$pdf->AddPage();
$pdf->Image("assets/img/{$application['PROGRAM_TITLE']}.png",10,5,$pdf->GetPageWidth()-20,$pdf->GetPageHeight()-20);
$pdf->SetFont('Times','',10);
$pdf->text(10,285,"Powered by: Information Technology Services Centre (ITSC)");
$pdf->SetFont('Times','',7);
$pdf->text(110,285,$data);
