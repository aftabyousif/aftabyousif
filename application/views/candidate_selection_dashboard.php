...
<div class="dual-list-box-area mg-b-15" id = "min-height">
	...
	<br/>
		...
		<div class="row">
			...
			<div class="col-md-5">
			    <p>Pay your challan online via HBL Mobile App: <a href='https://youtu.be/P7zEJrCMYjs' target="_new">Watch Tutorial</a></p>
			    <p>Pay your challan online via HBL Website: <a href='https://youtu.be/Bf-WItN_vdM' target="_new">Watch Tutorial</a></p>
			    <p>Pay your challan online via Konnect App: <b>Coming Soon</b></p>
			    <p>How to create Konnect Account for online payments? <a href='https://youtu.be/Q0NjTWAMgxQ' target="_new">Watch Tutorial</a></p>
			</div>
			<span id="msg"></span>
		</div>
		<div id="display"></div>
