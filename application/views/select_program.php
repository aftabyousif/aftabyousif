                        ...
                        <div id="dropzone1" class="pro-ad">
                            <div class="card">
                                <div class='card-header'>
                                    <center><h3>Please give your choices in preference order<br>Morning Choices</h3></center>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <strong>
                                           Please select minimum <?=5;?> and maximum <?=30?> choices of Subjects / Disciplines / Programs in order of preference according to your last qualification.<br> 
                                            Please check prospestus for pre-requiste for each degree program.<br>
                                             <span class='text-danger '><em>Red highlighted degree programs / disciplines / subjects indicates NO eligiblity according to last qualification</em></span>
                                            </strong>
                                            <br>
                                            <strong class=' text-info '>
                                                If you are applying for admission in only Evening Degree Program(s) like (LLM / M.Sc Criminology / MBA Evening), you are advised to press the <span class='blink_me text-success'>SAVE & NEXT</span> button. On the next page you will find the list of Master Evening Degree Programs.
                                            </strong>    
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <form action="<?=base_url()."form/upload_program_handler"?>"method="post" id = "select_choice_form"  enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div style="margin-top:35px">
                                                            ...
                                                            if($RESULT_IMAGE){
                                                                $image_path_default=itsc_url().EXTRA_IMAGE_PATH.$RESULT_IMAGE;
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg" onclick="window.location.href = '<?=base_url('form/select_category')?>'">Back</button>
                                         </span>
                                        </div>
                                             <div class="col-md-3">
                                                 <br>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <br>
                                                  ...
                                                  <span class="input-group-btn">
                                                    ...
                                                    <button type="button" class="btn btn-success " onclick="get_next()" ><i class="fa fa-next"></i> Save & Next </button>>
                                                  </span>
                                            </div>
                                        </div>
                                    </form>
...
<script>
    let is_evening_category = <?=$is_evening_category?>;
    <?php
    if(!$show_lat_form){
    ...
    $('#select_choice_form').submit(function (event) {
        ...
        jQuery.ajax({
            url: "<?=base_url()?>form/upload_program_handler",
            type: "POST",
            ...
            success: function (data, status) {
                ...
                //console.log(is_next);
                if(is_next==true){
                    if(is_evening_category){
                     window.location.href = '<?=base_url('form/evening_choices')?>';   
                    }else{
