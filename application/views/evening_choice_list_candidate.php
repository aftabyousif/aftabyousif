						...
						<div id="dropzone1" class="pro-ad">
							<div class="card">
								<div class='card-header'>
									<center><h3>Please give your choices in preference order<br>Evening Choices</h3></center>
								...
								<div class="card-body">
									...
									<form action="<?=base_url()."form/upload_evening_choices"?>"method="post" id = "select_choice_form"  enctype="multipart/form-data">
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg" onclick="window.location.href = '<?=base_url('form/select_program')?>'">Back</button>
                                         </span>
                                        </div>
											<div class="col-md-3">
...
<script>
	...
	$('#select_choice_form').submit(function (event) {
		...
		jQuery.ajax({
			url: "<?=base_url()?>form/upload_evening_choices",
			type: "POST",
