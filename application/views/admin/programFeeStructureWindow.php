...
<!--					</div>-->
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="login-social-inner">
					<a href="#" class="button btn-social basic-ele-mg-b-10 facebook span-left" ng-click="getFeeStrecture(ProgramTypesModel,ShiftsModel,CampusModel,ProgramModel,SessionModel,PartModel,SemesterModel,FeeCategoryModel)"> <span><i class="fa fa-search"></i></span> Search Report </a>
			...
			<div class="asset-inner">
				<table class="table table-condensed">
					...
					<tr ng-repeat="x in z.DATA track by $index" style="font-size: 10pt">
					    <td>{{x.PART_ID}}</td>
					    <td>{{x.FEE_PROG_LIST_ID}}</td>
						<td>{{x.FEE_TYPE_TITLE}}</td>
...
<script type="text/javascript">
	...
	app.controller('formCtrl', function($scope,$http,$window) {
		...
		$scope.getFeeStructure	= function (program_type_id,shift_id,campus_id,program_id,session_id,part_id,semester_id){
			...
			$http.post('<?=base_url()?>FeesReports/getFeeStrecture',data).then(function success(response){
