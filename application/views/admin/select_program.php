                        ...
                        <div id="dropzone1" class="pro-ad">
                            <div class="card">
                                <div class='card-header'>
                                    <center><h3>Please give your choices in preference order</h3></center>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form action="<?=base_url()."AdminPanel/upload_program_handler"?>"method="post" id = "select_choice_form"  enctype="multipart/form-data">
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg" onclick="window.location.href = '<?=base_url('AdminPanel/select_category')?>'">Back</button>
                                         </span>
                                        </div>
                                             <div class="col-md-3">
                                                 <br>
...
<script>
    ...
    $('#select_choice_form').submit(function (event) {
        ...
        jQuery.ajax({
            url: "<?=base_url()?>AdminPanel/upload_program_handler",
            type: "POST",
            ...
            success: function (data, status) {
                ...
                //console.log(is_next);
                if(is_next==true){
                    window.location.href = '<?=base_url('AdminPanel/student_update')?>';
                }
                is_next = false;
