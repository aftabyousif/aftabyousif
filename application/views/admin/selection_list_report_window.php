...
<!--		<form class="container-fluid">-->
			...
			?>
			<?=form_open(base_url().'Selection_list_report/display_selection_list_pdf',$attribute)?>
			<div class='row'>
			    <div class='col-md-6'>
			        <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $('#session').change(function (){
        ...
        if(session_id>0){
            jQuery.ajax({
                url: "https://admission.usindh.edu.pk/admission/AdminPanel/getTestType?SESSION_ID="+session_id,
                async:true,
	...
	function loadMappedPrograms (){
        ...
        $("#PROG_LIST_ID").html('');
	        jQuery.ajax({
                    url:'https://admission.usindh.edu.pk/admission/mapping/getMappedPrograms',
                    method: 'POST',
