		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="product-status-wrap">
					<h4>Import Bank CMD</h4>

					<div class="form-group-inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<input type="file" id="fileUpload" class="form-control basic-ele-mg-b-10 responsive-mg-b-10" />
							</div>
					...
					<div class="form-group-inner">
						<div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								<button type="button" id="upload"  class="form-control  basic-ele-mg-b-10 responsive-mg-b-10 btn btn-sm btn-primary" title="Click here system will show you excel file here before uploading in database" style="background-color: #00cae3"><i class="fa fa-file-excel-o"></i>&nbsp; <strong>Analyze Excel</strong></button>
							</div>
							...
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								<a  href="<?=base_url()?>assets/template _for_column.xlsx" target='_blank'class=" responsive-mg-b-10 btn btn-sm btn-warning" title="Click here to Download Template" style="background-color: #ff8d00">Download Template </a>
							</div>
						</div>
					</div>
...
let records = "";
	...
	function import_db(){
		...
		let array_cmd = JSON.stringify(records);
		let bank_account_id = $("#bank_account_id").val();
		if (bank_account_id == 0 || bank_account_id == "" || isNaN(bank_account_id))
		{
		...
		$.ajax({
			url:'<?=base_url()?>Cmd/cmd_import',
			type: 'POST',
			data: {array_cmd:array_cmd,bank_account_id:bank_account_id},
			// dataType: 'json',
