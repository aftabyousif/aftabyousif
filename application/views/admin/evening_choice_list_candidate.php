						...
						<div id="dropzone1" class="pro-ad">
							<div class="card">
								<div class='card-header'>
									<center><h3>In which program do you want to study in evening?</h3></center>
									<center><p style="color: white; font-weight: bolder">Please give your choices in preference order</p></center>
								</div>
								<div class="card-body">
									<?php
									...
									<div class='row'>
										<div class='col-md-12'>
											<strong>
												Please select minimum <?=$min_msg;?> and maximum <?=$max?> choices of Subjects / Disciplines / Programs in order of preference according to your last qualification.<br>
									...
									<form action="<?=base_url()."AdminPanel/upload_evening_choices"?>"method="post" id = "select_choice_form"  enctype="multipart/form-data">
...
<script>
	...
	$('#select_choice_form').submit(function (event) {
		...
		jQuery.ajax({
			url: "<?=base_url()?>AdminPanel/upload_evening_choices",
			type: "POST",
			...
			success: function (data, status) {
				...
				//console.log(is_next);
				if(is_next==true){
					//window.location.href = '<?=base_url('form/check_final_validation_evening/final_lock_evening')?>';
				}
				is_next = false;
