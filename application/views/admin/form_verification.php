...
<!--		<form class="container-fluid">-->
			<div class="sparkline10-hd">
				<div class="main-sparkline10-hd text-center bg-warning">
					<h1>Applicant Form Verification Panel</h1>
				</div>
			</div>
			...
			?>
			<?=form_open(base_url().'FormVerification/VerificationStart')?>
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-2">
					...
					<select name="application_status" id="application_status" class="form-control">
						...
						{
						    if($role_id!=1){
						        if($application_status['STATUS_ID']<=2){
						            continue;
						        }
						    }
							?>
				...
				<div class="col-md-2">
					...
					<select name="district_id" id="district_id" class="form-control">
						...
						?>
						<option value="-1">--OTHER PROVINCE--</option>
					</select>
				</div>
			...
			<div class="button-style-two btn-mg-b-10">
				<button type="submit" class="btn btn-custon-rounded-two btn-primary"><i class="fa fa-play edu-informatio" aria-hidden="true"></i> Start Verification</button>
