	...
	<div class="sparkline10-list">
		...
		<div class="sparkline10-hd">
			<div class="main-sparkline10-hd text-center bg-warning">
				<h1>Selected Candidates Program Wise</h1>
			</div>
		</div>
		<div ng-app="myApp" ng-controller="formCtrl">
			<div class='row'>
				<div class='col-md-6'>
					...
					<div class="col-md-4">
						...
						<select ng-model="ProgramTypesModel" class="form-control" ng-change="getPrograms(ProgramTypesModel,ShiftsModel,CampusModel);">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="login-social-inner">
					<a href="#" class="button btn-social basic-ele-mg-b-10 facebook span-left" ng-click="getReport(ProgramTypesModel,ShiftsModel,CampusModel,ProgramModel,SessionModel)"> <span><i class="fa fa-search"></i></span> Search Report </a>
...
<script type="text/javascript">
	...
	app.controller('formCtrl', function($scope,$http,$window) {
		...
		$scope.getReport	= function (program_type_id,shift_id,campus_id,program_id,session_id){
			...
			let data = {program_type_id:program_type_id,shift_id:shift_id,campus_id:campus_id,session_id:session_id,program_id:program_id};
			$http.post('<?=base_url()?>Selection_list_report/selectedReportHandler',data).then(function success(response){
