...
<div id = "min-height" class="container-fluid" style="padding:30px">
    <div class="row">
         <div class="alert alert-warning" role="alert">
                                <strong><p style="text-align: center; font-size: 12pt"><a href='<?=base_url()?>assets/FEES STRUCTURE SP.SELF FINANCE 2022.pdf' target='_blank' class='text-danger'>Click here For Fees Structure Special Self Finance 2022.</strong> </a> </p>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <strong>
                                                Please select minimum <?=$min_msg;?> and maximum <?=10?> choices of Subjects / Disciplines / Programs in order of preference according to your last qualification.<br>
...
<script>
    ...
    $('#select_choice_form').submit(function (event) {
        ...
        jQuery.ajax({
            url: "<?=base_url()?>AdminPanel/upload_special_self_choices",
            type: "POST",
