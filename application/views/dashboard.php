...
<div id = "min-height" class="container-fluid" style="padding:30px">
    <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <!--      <strong>You will have to add your qualifications later on. You will be notified through Email. Keep visiting your email account and E-portal account dashboard for further process regarding Admissions 2022.</strong> -->
                          <!--  </div>-->
                            ...
                            <!--</div>-->
                              ...
                              <div class="alert alert-warning" role="alert">
                                <strong><p style="text-align: center; font-size: 12pt"><a href='<?=base_url()?>CandidateSelection' target='new'>Click here to Download Admission Fees Challan, if you are selected in Provisional Merit List.</strong> </a> </p>
                            </div>
                         <!--<div class="alert alert-success" role="alert">-->
...
<!--                                <strong>-->
<!--                                        <ul >-->
<!--                                            <li style='padding-top:10px'>1) University of Sindh has extended the date for submission of online admission forms upto Friday 28.10.2022</li>-->
...
<!--Admit card / Admit Slip will be available here on this dashboard in PDF format after Friday 28.10.2022</li>-->
<!--                                              <li style='padding-top:10px'>3) Candidates applying for admissions to the <b>Bachelor Degree Program</b>, please complete/ process the First Three steps of the Online Admission form. Soon after the conduct of Pre-Entry Test and announcement of pending results of intermediate exams by all the concerned Boards of Sindh Province, options for adding <b>Qualifications</b>, selecting <b>Category</b>(ies) and <b>Choice</b>(s), will be opened.</li>-->
<!--                                        </ul>-->
<!--                                </strong> -->
<!--                            </div>-->
                        <center>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <th class='text-success' ><?=$user_application['STATUS_NAME']?></th>
                                                        </tr>
                                                        <tr >
                                                            <th >Form Remarks</th>
                                                        ...
                                                        if($user_application['IS_VERIFIED']=="Y" &&$user_application['CHALLAN_IMAGE']){
                                                                     ...
                                                                     $upload_button = "<button class='btn btn-danger'>Not Verifed / Rejected</button><span class='text-danger'><br>Your uploaded challan image is not verified that's why your Admit card will not be issued. If you have paid the challan within due dates, please visit Directorate of Admissions, University of Sindh, Jamshoro along with original paid copy of your challan upto Friday 04.11.2022 within office hours (09:00am to 03:00pm) OR you can send it through email at <span class='text-info' >admission@usindh.edu.pk</span>";
                                                                     $is_challan_show =false;
                                                        }else{
                                                                    $upload_button="<button class='btn btn-warning'>Pennding Verification</button>";
                                                        }    
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr >
                                                            ...
                                                            if($admit_card_url!=null&&$admit_card['IS_DISPATCHED']=='Y'&&($user_application['STATUS_ID'] == 1 ||$user_application['STATUS_ID'] == 3||$user_application['STATUS_ID'] == 4||$user_application['STATUS_ID'] == 5)){
                                                                if($user_application['STATUS_ID'] == 5){
                                                                ?>
                                                                <a href='<?=$admit_card_url?>' class='btn btn-primary' target='new'> Click Here To Print Admit Card</a>
                                                                <?php
                                                                }else{
                                                                ...
                                                                if($user_application['PROGRAM_TYPE_ID']==2){
                                                                    echo "There is no Pre-Entry Test for admission to Master Degree programs except LL.M (Evening) Degree Program. Merit Lists will be made on their Academic Marks.";     
                                                                }else{
                                                                    if($user_application['SESSION_ID']==9){
                                                                        if($admit_card){
                                                                      //  echo '<span class="bg-dark" style="background-color: black;color: white;padding: 2px;">Your admit card  for Pre-Entry Test - 2023 (Phase-II) will be issued on Friday November 4, 2022. Pre-Entry Test - 2023 (Phase-II) will be conducted on Sunday 6, 2022.</span>';    
                                                                        }else{
                                                                           // echo '<span class="bg-dark" style="background-color: black;color: white;padding: 2px;">Your admit card  for Pre-Entry Test - 2023 (Phase-II) will be issued on Friday November 4, 2022. Pre-Entry Test - 2023 (Phase-II) will be conducted on Sunday 6, 2022.</span>';    
                                                                    //        echo '<span class="text-danger" style="padding: 2px;">Your Admit Card is not issued. If you have any query, please visit Directorate of Admissions, University of Sindh, Jamshoro upto Friday 04-11-2022 during office hours (09:00am to 03:00pm) OR send Email at admission@usindh.edu.pk</span>';
                                                                        }
                                                                        
                                                                    }
                                                                    //echo "Please send your cnic No. and image of paid challan at admission@usindh.edu.pk ";
                                                                }
                                                        ...
                                                        <tr >
                                                            ...
                                                            <th > <?php
                                                                  ...
                                                                  if (($user_application['STATUS_ID'] >= 3 && $user_application['STATUS_ID'] <= 5)&&$test_cpn!=null&&isset($test_cpn['TEST_SCORE'])&&$test_cpn['TEST_SCORE']){
                                        ...
                                        <?php
                                                ...
                                                ?>
                                                 <div class="row"> 
                                                    <div class="col-md-12">
                                                        <div class="alert alert-danger" role="alert">
                                                             <strong><a href='<?=$special_self?>' target='new' style='color:red;' onclick="return confirm('Are you sure\nYou want to apply for Special Self Finance Category??')"><h2>Click Here To Apply For Special Self Finance</h2> </a></strong>
                                                          </div>
                                                    </div>
                                                </div>
                                                <?php
                                                ...
                                                ?>
                                                 <?php
                                                if($IS_SUPER_PASSWORD_LOGIN=='Y'||(OPEN_EVENING_PORTAL==1&&($user_application['STATUS_ID']<=5&&$user_application['STATUS_ID']>=1))){
                                                ?>
                                                <!-- <div class="row"> -->
                                                <!--    <div class="col-md-12">-->
                                                <!--        <div >-->
                                                <!--             <strong><a href='<?=$eveining_link?>'  style='color:red;' onclick="return confirm('Are you sure\nYou Want To Apply in Evening Degree Programs?')"><h2>Click Here To Apply For Evening Degree Programs</h2> </a></strong>-->
                                                <!--          </div>-->
                                                <!--    </div>-->
                                                <!--</div>-->
                                                <?php
...
<!--						style="border: 1px solid black; padding: 5px"-->
						<div class="profile-details-hr" >
							...
							<div class="row">
								...
								<!--<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">-->
								<!--	<div class="address-hr tb-sm-res-d-n dps-tb-ntn">-->
								<!--		<p><b>Hard Copy Form</b><br /><span class='text-danger'><i class='fa fa-check-circle-o'></i> {{stdData.FORM_STATUS}} </span> </p>-->
								<!--	</div>-->
								<!--</div>-->

								<!--<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">-->
								<!--	<div class="address-hr tb-sm-res-d-n dps-tb-ntn">-->
								<!--		<p><b>Paid Amount</b><br /><span class='bg-primary'>{{stdData.PAID_AMOUNT}} </span> </p>-->
								<!--	</div>-->
								<!--</div>-->
...
<!--								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">-->
<!--									<div class="address-hr tb-sm-res-d-n dps-tb-ntn">-->
<!--										<p><b>Provisional Admission Letter</b><br /> <a href="--><?//=base_url()?><!--form/admission_letter/{{stdData.SELECTION_LIST_ID}}" target="_blank" class=""><i class="fa fa-file-pdf-o">&nbsp;&nbsp;&nbsp;Download/Print</i></a> </p>-->
<!--									</div>-->
<!--								</div>-->
							</div>
			...
			$http.post('<?=base_url()?>Form/getApplicantCurrentSelection').then(function success(response) {
				...
				if (response.status == 200) {
					...
					array_data =  array_data.filter((data)=>{
					      // console.log(data);
					       return data.YEAR==2022?data:null;
