...
//		$CI =& get_instance();
    ...
    {
        $this->legacy_db->select("dqs.DISTRICT_ID,dqs.PROG_LIST_ID,pl.`PROGRAM_TITLE`,dqs.`RURAL_SEATS`,dqs.`URBAN_SEATS`,dqs.`TOTAL_SEATS`,dqs.`RURAL_SEATS_REMAINING`,dqs.`URBAN_SEATS_REMAINING`,dqs.`TOTAL_SEATS_REMAINING`");
