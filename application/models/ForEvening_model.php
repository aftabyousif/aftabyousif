 ...
 * Time: 3:44 PM
 */
class ForEvening_model extends CI_Model
{
...
//		$CI =& get_instance();
    ...
    function getTestResultAndCPNbyTestIdAndCampusId($test_id,$campus_id){
        ...
        $this->legacy_db->where('ac.FORM_CATEGORY_ID', SELF_FINANCE_EVENING);
...
//        exit();
   ...
   * */
    ...
    function ForEveningGetFeeLedger($admission_session_id,$shift_id,$session_id,$prog_type_id,$test_id){
